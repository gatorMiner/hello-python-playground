...
#check if printing is enabled using boolean variable
conditional_logic_example = False
...
#------------------------------------
#start of user-input playground
#------------------------------------

#check if printing is enabled using boolean variable
userInput_logic_example = True
    
if userInput_logic_example:
    print("This begins the user-input logic example.")
else:
    print("Maybe the end of examples.")  
...
s = user_name 
if s.strip() == "":
    user_name = "Guest" #default name if empty input
...
s = user_age_input
if s.strip() == "":
    user_age_input = "0" #default age if empty input
user_age = int(user_age_input)
print(f"You are {user_age} years old.")
print(blank_line)

#Prompt user for an float value.
pi_input = input("Please enter the value of Pi: ")
s = pi_input
if s.strip() == "":
    pi_input = "3.14" #default value if empty input
pi = float(pi_input)
print(f"The value of Pi is approximately {pi}.")
print(blank_line)

#start of while loop examples
...
#letting user choose when to quit in a loop
msg 
while msg != 'quit':
    msg = input("Enter a message (type 'quit' to exit): ")
    if msg != 'quit':
